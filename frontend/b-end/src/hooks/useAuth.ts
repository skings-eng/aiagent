...
// B-end uses simple local authentication for Gemini client
...
// Simple local storage management for B-end
const userManager = {
  getUser: (): User | null => {
...
export const useAuthProvider = (): AuthContextType => {
  ...
  const login = async (email: string, password: string) => {
    try {
      setIsLoading(true);
      // B-end uses simple mock authentication for demo purposes
